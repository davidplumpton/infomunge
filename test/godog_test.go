...
func InitializeScenario(ctx *godog.ScenarioContext) {
	...
	ctx.Step(`^the authoritative testing docs should show bounded repo-wide package test commands$`, tc.theAuthoritativeTestingDocsShouldShowBoundedRepoWidePackageTestCommands)
	...
	ctx.Step(`^the lazy evaluation documentation example$`, tc.theLazyEvaluationDocumentationExample)
