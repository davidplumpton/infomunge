...
func assertionBuiltinSpecs() []BuiltinSpec {
	return []BuiltinSpec{
		...
		regularBuiltinSpec("beGreaterThan", builtinCategoryAssertions, exactArity(1), callBeGreaterThan, "greater-than matcher"),
		regularBuiltinSpec("beLowerThan", builtinCategoryAssertions, exactArity(1), callBeLowerThan, "lower-than matcher"),
