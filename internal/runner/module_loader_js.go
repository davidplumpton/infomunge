...
// NewModuleLoader creates a module loader that disables imports in JS builds.
func NewModuleLoader(baseDir string) *ModuleLoader {
	return &ModuleLoader{BaseDir: baseDir}
}

// Resolve is not supported in JS builds.
...
// Load is not supported in JS builds.
