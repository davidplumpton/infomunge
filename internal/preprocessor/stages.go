...
func functionalProcessingContracts() []TransformContract {
	return []TransformContract{
		...
		configuredBinaryOperatorTransform("replaceScanOperator", TransformPhaseFunctional, 300, binaryOpScan, TransformPrecedenceComparison, TransformAssociativityLeft),
